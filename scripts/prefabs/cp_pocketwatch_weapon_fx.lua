...
local SPARKLE_TEXTURE = MODROOT .. "fx/cp_pocketwatch.tex"
local ADD_SHADER = MODROOT .. "shaders/vfx_particle_add.ksh"
...
return Prefab("cp_pocketwatch_weapon_fx", fn, assets)
